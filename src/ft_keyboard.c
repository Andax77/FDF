...
int 	ft_color(int keycode, int R, int G, int B)
{
	...
	if (keycode == 24)//+
	{
		(R > 0 && G < 255 && B == 0) ? R -= 15, G += 15 : 1;
		(G > 0 && B < 255 && R == 0) ? G -= 15, B += 15 : 1;
		(B > 0 && R < 255 && G == 0) ? B -= 15, R += 15 : 1;
	}
	if (keycode == 27)//-
	{
		(R < 255 && G > 0 && B == 0) ? R += 15, G -= 15 : 1;
		(G < 255 && B > 0 && R == 0) ? G += 15, B -= 15 : 1;
		(B < 255 && R > 0 && G == 0) ? B += 15, R -= 15 : 1;
	}
